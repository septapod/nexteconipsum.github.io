        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12 pt-12">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto font-light leading-relaxed">
              Generate placeholder text using the language of post-capitalism, inclusive economics, and regenerative economics.
            </p>
          </div>
            ...
            <div className="flex flex-wrap gap-8 items-end">
              <div className="flex-1 min-w-56">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all backdrop-blur-sm"
                >
              ...
              <div className="flex-1 min-w-40">
                ...
                <input
                  type="number"
                  min="1"
                  max={outputType === 'paragraphs' ? 10 : outputType === 'sentences' ? 25 : 500}
                  value={count}
              ...
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-emerald-500 to-purple-600 text-white rounded-xl hover:from-emerald-400 hover:to-purple-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all flex items-center gap-3 font-medium shadow-lg hover:shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          {generatedText ? (
            <div className="backdrop-blur-xl bg-white/10 rounded-2xl border border-white/20 shadow-2xl overflow-hidden">
              <div className="p-8">
                ...
                <div className="relative">
                  {isGenerating && (
                    <div className="absolute inset-0 flex items-center justify-center bg-slate-800/20 backdrop-blur-sm rounded-xl z-10">
                      <div className="flex items-center gap-3 text-emerald-400">
                        <RefreshCw className="w-6 h-6 animate-spin" />
                        <span className="font-medium">Generating next economy text...</span>
                      </div>
                    </div>
                  )}
                  
                  <div className="bg-slate-800/30 rounded-xl border border-slate-700/50 p-6 backdrop-blur-sm">
                    {generatedText.split('\n\n').map((paragraph, index) => (
                      <p key={index} className="mb-6 last:mb-0 leading-relaxed text-slate-200 text-lg font-light">
                        {paragraph}
                      </p>
                    ))}
                  </div>
            ...
            <div className="text-center py-16">
              <div className="mb-8">
                <Sparkles className="w-16 h-16 text-emerald-400/50 mx-auto mb-4" />
                <h3 className="text-2xl font-light text-white mb-2">Ready to Generate</h3>
                <p className="text-slate-400 text-lg">Click "Generate" to create your next economy ipsum text</p>
              </div>
              <button
                onClick={generateText}
                className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-purple-600 text-white rounded-xl hover:from-emerald-400 hover:to-purple-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all text-lg font-medium shadow-lg hover:shadow-emerald-500/25 flex items-center gap-3 mx-auto"
              >
          ...
          <div className="text-center mt-16 pb-8 text-slate-400">
            ...
            <div className="mt-6 pt-4 border-t border-slate-700/50">
              <p className="text-sm opacity-90">
                Made with 🤍 by <a 
                  href="https://www.linkedin.com/in/dxn/" 
                  target="_blank" 
...
export default NextEconomyIpsum;
